...
The purpose of this policy is to establish standards for the accessibility of EIT considered necessary to ensure compliance with applicable local, state and federal regulations and laws. This policy ensures that all digital information (EIT) is designed, developed, and procured to be accessible to all individuals with disabilities.
...
CSCU’s technical standards for measuring accessibility are those published by the Web Accessibility Initiative (WAI) of the World Wide Web Consortium (W3C). CSCU follows the most current published version of the Web Content Accessibility Guidelines ([WCAG](https://www.w3.org/WAI/intro/wcag)). At the time of adoption of this Policy, those guidelines were (a) [WCAG 2.1 Level AA for Web-based EIT](https://www.w3.org/TR/WCAG21/) and (b) guidelines for [Applying WCAG 2.1 to Non-Web Information and Communications Technologies](https://www.w3.org/TR/wcag2ict/), [WCAG2ICT](https://www.w3.org/TR/wcag2ict/). These technical standards shall be updated as needed to remain current with the most recent WCAG guidelines. CSCU will also look for guidance to applicable provisions of the United States Access Board’s Electronic and Information Technology Accessibility Standards under Section 508 of the Rehabilitation Act of 1973 as well as State of Connecticut’s Universal Website Accessibility Policy for State Websites.
